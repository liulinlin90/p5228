...
from keras.layers import LSTM,GlobalAveragePooling1D, Conv1D, Dropout
...
output = (output >= 0.50)
np.savetxt('../../../data/stage1_rnn5/test_0-800000_rnn_output.csv', output.ravel(), fmt='%d')
...
output = (output >= 0.50)
np.savetxt('../../../data/stage1_rnn5/train_0-800000_rnn_output.csv', output.ravel(), fmt='%d')
