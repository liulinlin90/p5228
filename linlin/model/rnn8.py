...
output = (output >= 0.50)
np.savetxt('../../../data/stage1_rnn8/test_0-800000_rnn_output.csv', output.ravel(), fmt='%d')
...
output = (output >= 0.50)
np.savetxt('../../../data/stage1_rnn8/train_0-800000_rnn_output.csv', output.ravel(), fmt='%d')
